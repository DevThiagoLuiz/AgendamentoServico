...
- Crie um projeto react com create-vite: `npm init --yes vite@latest agendamentoservico.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Criar o arquivo de projeto (`agendamentoservico.client.esproj`).
